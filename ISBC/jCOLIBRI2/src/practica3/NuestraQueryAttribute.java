 ...
 *
 */
public class NuestraQueryAttribute
{
	...
	String info = "Por favor, elige una categoria de juego para iniciar la recuperación: ";
	...
	ParameterEditor pe = ParameterEditorNuestro.getEditor(attribute.getType(), values);
