...
import es.ucm.fdi.gaia.ontobridge.util.ToStringIterator;
...
public class OntoBridge {
	...
	public void credits()
	{
		String c = "\nThis is OntoBridge v1.4." +
				"\nDeveloped by GAIA - Group for Artificial Intelligence Applications." +
				"\nhttp://gaia.fdi.ucm.es";
		org.apache.commons.logging.LogFactory.getLog(this.getClass()).info(c);
	}
	...
	public void save(FileWriter fw)
	{
		try {
			...
			org.apache.commons.logging.LogFactory.getLog(this.getClass()).info( "Saving ontology.");
		} catch (Exception e) {
			org.apache.commons.logging.LogFactory.getLog(this.getClass()).error(e);
		}
