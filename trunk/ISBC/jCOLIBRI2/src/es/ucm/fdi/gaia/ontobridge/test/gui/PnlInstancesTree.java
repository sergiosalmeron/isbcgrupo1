...
public class PnlInstancesTree extends JPanel{
	...
	private static 	Icon INSTANCE = new javax.swing.ImageIcon(PnlInstancesTree.class.getResource("/es/ucm/fdi/gaia/ontobridge/test/gui/instance.gif"));
	private static 	Icon DATATYPE = new javax.swing.ImageIcon(PnlInstancesTree.class.getResource("/es/ucm/fdi/gaia/ontobridge/test/gui/datatype.gif"));
	private static 	Icon PROPERTY = new javax.swing.ImageIcon(PnlInstancesTree.class.getResource("/es/ucm/fdi/gaia/ontobridge/test/gui/property.gif"));
