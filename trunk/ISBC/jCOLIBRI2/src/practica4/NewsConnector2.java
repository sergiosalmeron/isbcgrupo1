...
public class NewsConnector2 implements Connector {

	String newsFolder;
	int maxFilesPerCategory;
	
	public NewsConnector2(String newsFolder, int maxFilesPerCategory)
	{
	...
	private CBRCase parseFile(File htmlFile, String category) {
		...
		try {
			...
			IETextOpenNLP text = new IETextOpenNLP(texto);
			NewsDescription2 desc = new NewsDescription2();
	...
	public static void main(String[] args) {
		...
		NewsConnector2 connector = new NewsConnector2("C:/hlocal/workspaceISBC/jCOLIBRI2/src/practica4/noticias",150);
